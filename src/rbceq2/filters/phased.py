...
from rbceq2.filters.shared_filter_functionality import flatten_alleles, all_hom,check_hom, check_phase, check_phase_set
        ...
        if pair_with_unphased_HETs: #TODO this was written after a big meal... 
            ...
            for pair in bg.alleles[allele_state]:
                for allele in pair:
                    # if bg.type == 'LU':
                    #     ic(4444)
                    if all_hom(bg, allele) and any(allele in flat_allele for flat_allele in flattened_alleles):
                        to_remove.append(pair)
